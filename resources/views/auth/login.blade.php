...
<body class="login-page" style="max-width: 500px;">
    <div class="logo" style="font-size: 25px;text-align: center;margin-bottom: 20px;">
            <a href="javascript:void(0);" style="color: white;">JASA PENYEDIA SWABTEST COVID-19</a>
        </div>
    <div class="login-box">
            ...
            <div class="body">
                ...
                {{-- <div class="row">
                    <div class="col-xs-8 p-t-5" style="margin-left: 30%; margin-top: -14%;">
                        <a href="{{ URL::to('/tambah-pengguna') }}" class="btn btn-block bg-pink waves-effect" style="width: auto; margin-top: -3%;">REGISTER</a>
                    </div>
